...
- Make it **descriptive** (small, focused, incremental changes — per `docs/base-standards.md` §Core Principles).
...
- `docs/base-standards.md` §Core Principles and `docs/openspec-tasks-mandatory-steps.md` §Step 0: feature branches, small focused changes, descriptive commits.
